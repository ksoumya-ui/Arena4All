...
//     }
//     User.find().sort('_id').paginate(page, itemsPerPage, (err:any, users:any, total:any) => {
//         if (!users)
...
// var getCounters = (req:any, res:any) =>{
...
// async function getCountFollow(user_id:any) {
...
// var updateUser = (req:any, res:any) =>{
//     var userId = req.params.id;
//     var update = req.body;
...
// var uploadImage = (req:any, res:any) =>{
//     var userId = req.params.id;
//     if (req.files) {
...
//             User.findByIdAndUpdate(userId, {image: file_name}, {new : true}, (err:any, userUpdated:any) => {
//                 if (!userUpdated)
//                     return res.status(404).send({message: "User Not Found."});
//                 if (err)
//                     return res.status(500).send({message: "Request Error."});
...
// var removeFilesOfUploads = (res:any, file_path:any, message:any)=> {
//     fs.unlink(file_path, (err:any) => {
//         return res.status(200).send({message: message});
//     });
// }

// var getImageFile = (req:any, res:any)=> {
